...
import * as categorizePackages from '../features/categorize-packages';
import { CategorizationResult } from '../features/categorize-packages/types';
...
describe('categorize', () => {
  ...
  const categorizePackagesSpy = jest.spyOn(categorizePackages, 'categorizePackages');
