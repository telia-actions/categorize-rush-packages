...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.categorizeProjects = void 0;
const path_1 = __importDefault(__webpack_require__(622));
const json_client_1 = __webpack_require__(434);
const categorizeProjects = (rushProjects) => {
    const result = {
        category: {},
    };
    return rushProjects.reduce((categories, project) => {
...
const updatePackageCategories = (project, output) => {
    ...
    const { deployCategory } = json_client_1.readJson(packageJsonPath);
    if (deployCategory) {
